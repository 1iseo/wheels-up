        ...
        child: Container(
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                left: 20.0,
                top: 515.0, // Adjust position to be below the "Sebagai" field
                child: GestureDetector(
                  onTap: () {
                    // Action for "Lupa password?" can be added here
                  },
                  child: Text(
                    "Lupa password?",
...
class SyaratPage extends StatelessWidget {
  ...
  // Function to build photo input field
  Widget _buildPhotoInputField() {
    return Container(
      ...
      child: Row(
        children: [
          Padding(
            padding: const EdgeInsets.only(left: 10.0), // Padding for the icon
            child: Icon(
              Icons.add_a_photo,
              color: Colors.black,
            ),
          ...
          Expanded(
            child: TextField(
              enabled: false, // Disable typing in this field
              decoration: InputDecoration(
                border: InputBorder.none,
                hintText: 'Masukkan foto SIM',
                contentPadding: EdgeInsets.symmetric(horizontal: 16.0),
              ),
            ),
          ),
